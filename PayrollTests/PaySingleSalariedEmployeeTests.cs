...
namespace Payroll.Tests
{
   ...
   public class PaySingleEmployeeTests
   {
      ...
      public void PaySingleHourlyEmployeeOneTimeCard()
      {
         ...
         AddChangeTimeCardUseCase tc = new AddChangeTimeCardUseCase(empId, payDate, 2.0, database);
         tc.Execute();
         PaydayUseCase pt = new PaydayUseCase(payDate, database);
         pt.Execute();
      ...
      public void PaySingleHourlyEmployeeOvertimeOneTimeCard()
      {
         ...
         t.Execute();
         DateTime payDate = new DateTime(2001, 11, 9); // Friday
         AddChangeTimeCardUseCase tc = new AddChangeTimeCardUseCase(empId, payDate, 9.0, database);
         tc.Execute();
         PaydayUseCase pt = new PaydayUseCase(payDate, database);
         pt.Execute();
      ...
      public void PaySingleHourlyEmployeeTwoTimeCards()
      {
         ...
         AddChangeTimeCardUseCase tc = new AddChangeTimeCardUseCase(empId, payDate, 2.0, database);
         tc.Execute();
         AddChangeTimeCardUseCase tc2 = new AddChangeTimeCardUseCase(empId, payDate.AddDays(-1), 5.0, database);
         tc2.Execute();
         PaydayUseCase pt = new PaydayUseCase(payDate, database);
         pt.Execute();
      ...
      public void TestPaySingleHourlyEmployeeWithTimeCardsSpanningTwoPayPeriods()
      {
         ...
         AddChangeTimeCardUseCase tc = new AddChangeTimeCardUseCase(empId, payDate, 2.0, database);
         tc.Execute();
         AddChangeTimeCardUseCase tc2 = new AddChangeTimeCardUseCase(
         empId, dateInPreviousPayPeriod, 5.0, database);
         tc2.Execute();
         PaydayUseCase pt = new PaydayUseCase(payDate, database);
         pt.Execute();
      ...
      public void HourlyUnionMemberServiceCharge()
      {
         ...
         sct.Execute();
         AddChangeTimeCardUseCase tct = new AddChangeTimeCardUseCase(empId, payDate, 8.0, database);
         tct.Execute();
         PaydayUseCase pt = new PaydayUseCase(payDate, database);
         pt.Execute();
         Paycheck pc = pt.GetPaycheck(empId);
